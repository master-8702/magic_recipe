...
/// This file defines the schema for the Recipe class in the Magic Recipe Server application.
abstract class Recipe implements _i1.SerializableModel {
  ...
  /// Optional field for storing the path of ingredient image (if the user uploaded one)
  String? imagePath;
